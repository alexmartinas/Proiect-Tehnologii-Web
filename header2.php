...
<header class="logged-out" style="height: 82px;padding-top: 11px;">
	<div class="container clearfix">
		<ul class="list-inline unlogged-in">
			<li class="logo-wrap col-md-3 col-xs-3"> <a  class="navbar-brand" href="index.php"><img src="image/logo.png" class="img-circle" alt="" style="position:absolute; top: -95px;width: 240px;height: 250px; left: -152px;"></a></li><!--

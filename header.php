  ...
  <div id="navigator" class="container-fluid ">
    <div class="navbar-header" >
     <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">                       
      ...
      <a  class="navbar-brand" href="index.php"><img src="image/logo.png" alt="" class="img-circle" style="position:absolute; top: -100px;width: 240px;height: 250px; left: -45px;"></a>
    </div>

<?php
	...
	$stid = oci_parse($connection, 'call new_child(:v_id_tutore,:v_iddevice,:v_nume,:v_prenume,:v_varsta,:v_gen,:v_mesaj)');
	...
	oci_bind_by_name($stid, ":v_varsta", $varsta);
	oci_bind_by_name($stid, ":v_gen", $gen);
